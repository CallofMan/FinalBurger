...
<div id="boxAddUser">
    ...
    <div class='allInputs'>
        ...
        <form class="addUser" method="POST">
            <input type="text" maxlength="25" onkeyup="var yratext=/[0-9 -.:-@[-`{-~]/; if(yratext.test(this.value)) {alert('Вводите только буквы!'); this.value=''}" placeholder='Имя' name='addBuyerName' required>
            <input type="text" maxlength="25" onkeyup="var yratext=/[0-9 -,.:-@[-`{-~]/; if(yratext.test(this.value)) {alert('Больше это не вводите!'); this.value=''}" placeholder='Фамилия' name='addBuyerSurname' required>
            <button name="addBuyer">Добавить пользователя</button>
        </form>
        <form class='navButtons'method='POST'>
        <button name='addPos'> Добавление еды </button> <br>
    ...
    <div class='formSearch'>
        ...
        <div class='divI'>
            ...
            <input name='search 'class='search' maxlength="25" placeholder='Enter name & surname user' autofocus>
