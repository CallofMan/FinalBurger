...
<body>
    ...
    <form class='boxAdd' method='POST'> 
        ...
        <input type="text" maxlength="25" placeholder='Введите логин' name='authLogin' required>
        <input type="password" maxlength="25" placeholder='Введите пароль' name='authPass' required>
